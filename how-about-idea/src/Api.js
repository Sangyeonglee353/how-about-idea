...
export async function signUp(data){
    ...
    const res  = await axios.post(`${origin}/api/auth/signUp`,
    {
...
export async function signIn(data){
    ...
    const res  = await axios.post(`${origin}/api/auth/signIn`,
    {
...
export async function makeSentence(data){
    ...
    const res  = await axios.post(`${origin}/api/auth/saveSentence`,
    {
...
export async function searchSentence(str){
    ...
    const res  = await axios.get(`${origin}/api/auth/makeSentence/searchSentence/${str}`)
...
export async function searchWord(str){
    ...
    const res  = await axios.get(`${origin}/api/auth/makeSentence/searchWord/${str}`)
...
export async function createMindMap(data){
    ...
    const res  = await axios.post(`${origin}/api/auth/saveMindMap`,
    {
